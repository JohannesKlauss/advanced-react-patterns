...
I learned that refs need to be in the deps array without current.

Refs can be closured inside useMemo/useCallback to always reference the last value like this:

`() => debounce((...args) => latestCallback.current(...args), delay)`

This will always refer to the latest value of the ref.
