...
This is a very important pattern to understand how form elements work in react.

You can also enhance the typescript types of the component so that if you provide the on prop, you have to provide the onChange prop as well (except when readOnly is set).
Dive into this solution for our own spacetime workshop.
